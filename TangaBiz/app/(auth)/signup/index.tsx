    ...
    const handleSignUp = async () => {
        ...
        try {
            ...
            const response = await axios.post(
                `${process.env.EXPO_PUBLIC_BACKEND_URL}/api/tangabiz/auth/signup`,
                {
                    ownerName,
                    businessEmail,
                    businessName,
            ...
            Toast.show(e.response?.data?.message || 'Signup failed', {
                containerStyle: {
                    backgroundColor: 'red',
                },
                textStyle: {
        ...
        >
            ...
            >
                <View className="h-full w-full dark:bg-green-900 bg-green-600 flex flex-col justify-between">
                    {/* Header */}
                    <View className="flex flex-row justify-between items-center px-2 pt-12 mb-8">
                        <Pressable
                            onPress={() => router.back()}
                    ...
                    <MotiView
                        ...
                        className="bg-white dark:bg-slate-500 rounded-tr-3xl rounded-tl-3xl px-4 py-8 mt-auto"
                        style={{ flexGrow: 1 }}
                    >
                        <View className="flex flex-col gap-1">
                            <Text className="text-2xl dark:text-white font-semibold text-center mb-6">
                                Tanga<Text className="text-yellow-600">Biz</Text>
                            </Text>
                        </View>
                        ...
                        <TextInput
                            ...
                            secureTextEntry
                            className="rounded-xl p-4 mb-6 bg-gray-300 text-black dark:text-black dark:bg-white"
                        />
