...
export const StepOne = ({
    ...
    const getProducts = async () => {
        ...
        setError(null);
        try {
            const res = await axios.get(`${process.env.EXPO_PUBLIC_BACKEND_URL}/api/tangabiz/products?id=${id}`);
    ...
    const handleSearch = async (value: string) => {
        ...
        try {
            const res = await axios.get(`${process.env.EXPO_PUBLIC_BACKEND_URL}/api/tangabiz/products/search`, {
                params: {
                    searchTerm: value,
                    id
                }
